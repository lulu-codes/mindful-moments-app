...
#             print(f"\n{EMOJI_WARNING} Unexpected error occurred, please try again.")
...
# """ default param validation criteria set to accept spaces for journal entries,
# applied changed validation criteria for prompt_username and prompt_password separately when prompted in its function """
# def get_valid_input(
#         prompt: str,
#         field_name: str ="Input",
#         allow_blank: bool = False,
#         allow_spaces: bool = True,      # allowed spaces only for journal entries
#         min_length: int = 5,
#         max_length: int = 200,
